...
#pragma region KeybordMacro

// DirectInput Key Codes (DIK_XXX)
...
namespace MadoEngine
{
	...
	private:
		...
		std::array<bool, KEY_COUNT> currentState_;
		std::array<bool, KEY_COUNT> previousState_;

		int ConvertDIKToVK(int key) const;
	};
}
